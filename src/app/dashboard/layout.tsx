...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex h-screen bg-zinc-950 overflow-hidden relative selection:bg-indigo-500/30">
      ...
      <div className="flex flex-col flex-1 overflow-hidden relative z-10">
        ...
        <main className="flex-1 overflow-auto px-8 py-6 custom-scrollbar">{children}</main>
      </div>
    </div>
  );
}
